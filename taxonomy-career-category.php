    ...
    <div class="container">
        ...
        <div class="filter-table-wrap">
            ...
            <div class="ajax-btn-wrap mx-auto w-fit pt-9" id="load-more-container">
                <a class="btn btn-primary down btn-load-more" id="load-more-btn" data-taxonomy="career-category" data-term-id="<?php echo $term->term_id; ?>"><span><?php _e('Xem thêm', 'canhcamtheme'); ?></span><em class="fa-regular fa-chevron-down"></em></a>
            </div>
            <?php 
            // endif; 
            // ?>
