			...
			<div class="col w-full lg:w-1/2">
				<div class="txt-wrap lg:pr-18 ">
					...
					<h2 class="heading-1-up pt-8 mb-6 lg:pt-12 max-lg:text-center">
						<?php echo $title ? $title : __('Dự án', 'canhcamtheme'); ?></h2>
					<?php if($description): ?>
						...
						<div class="row item bg-grey-10">
							<div class="col w-full lg:w-4/12">
								<div class="txt p-8 lg:py-10">
									<div class="title text-primary-2 text-base mb-3"><?php echo $bid_package['name']; ?>
									</div>
									<h3 class="mb-6"><a href="<?php the_permalink(); ?>"
											class="heading-2 text-primary-1 hover:underline line-clamp-4"><?php the_title(); ?></a>
									</h3>
									<div class="scrollbar-wrap">
										<div class="list">
											<ul>
												...
												<li class="y-start">
													<div
														class="icon w-[24px] h-[24px] min-w-[24px] lg:w-6 lg:min-w-6 lg:h-6">
														<i class="fa-light fa-user"></i>
													</div>
													<div class="text-wrap ml-3">
														<div class="body-3 font-bold mb-1">
															<?php _e('Chủ đầu tư:', 'canhcamtheme'); ?></div>
												...
												<li class="y-start">
													...
													<div class="text-wrap ml-3">
														<div class="body-3 font-bold mb-1">
															<?php _e('Giá trị hợp đồng:', 'canhcamtheme'); ?></div>
												...
												<li class="y-start">
													...
													<div class="text-wrap ml-3">
														<div class="body-3 font-bold mb-1">
															<?php _e('Ngày hoàn thành:', 'canhcamtheme'); ?></div>
